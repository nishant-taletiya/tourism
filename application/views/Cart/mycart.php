						...
						<table class="table table-striped cart-list">
							...
							<tbody>
								<tr>
									<td>
										<div class="thumb_cart">
											<img src="../../via.placeholder.com/150x150/ccc/fff/thumb_cart_1.jpg" alt="Image">
										</div>
								...
								<tr>
									<td>
										<div class="thumb_cart">
											<img src="../../via.placeholder.com/150x150/ccc/fff/thumb_cart_2.jpg" alt="Image">
										</div>
								...
								<tr>
									<td>
										<div class="thumb_cart">
											<img src="../../via.placeholder.com/150x150/ccc/fff/thumb_cart_3.jpg" alt="Image">
										</div>
								...
								<tr>
									<td>
										<div class="thumb_cart">
											<img src="../../via.placeholder.com/150x150/ccc/fff/thumb_cart_4.jpg" alt="Image">
										</div>
