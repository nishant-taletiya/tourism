            ...
            <div class="account-box">
              ...
              <div class="account-content">
                <div class="text-center m-b-20">
                  <div class="m-b-20">
                    <div class="checkmark"> <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                  ...
                  <h3>See You Again !</h3>
                  <p class="text-muted font-13 m-t-10"> You are now successfully sign out. Back to <a href="<?php echo site_url() ?>/logincontroller/" class="text-primary m-r-5"><b>Sign In</b></a></p>
                </div>
              </div>
            </div>
            <!-- end card-box--> 
