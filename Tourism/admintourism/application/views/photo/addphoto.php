...
<div class="col-lg-6"  style="margin-left:450px; margin-top:90px;">
            <div class="card-box">
              <h4 class="header-title m-t-0" align="center">||---Add Photo---||</h4>
              <form enctype="multipart/form-data" action="<?php echo site_url() ?>/photocontroller/insert" method="post">
              <div class="fileupload fileupload-new" data-provides="fileupload">
                      ...
                      <div>
                        ...
                        <input name="photo"  type="file" class="btn-default" />
                        </button>
                         </div>
                    </div>
              <div class="form-group">
                  <label for="userName">Title<span class="text-danger">*</span></label>
                  <input type="text" name="title" required="" placeholder="Title" class="form-control" id="userName">
                </div>
