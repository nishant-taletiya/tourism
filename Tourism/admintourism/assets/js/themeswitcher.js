...
$(function() {
   "use strict";
    $('.set-adminheader-style').on('click', function() {
...
$(function() {
   "use strict";
    $('.set-sidebar-style').on('click', function() {
...
$(function() {
   "use strict";
    $('.set-background-style').on('click', function() {
...
$(function() {
   "use strict";
    $('.set-header-style').on('click', function() {
...
$(function() {
   "use strict";
    $('.set-footer-style').on('click', function() {
...
$(function() {
   "use strict";
    $('.set-topmenu-style').on('click', function() {
