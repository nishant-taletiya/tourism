...
jQuery(function($) {
  ...
  var AdminUXAdmin = window.AdminUXAdmin || {};
  ...
  /*--------------------------------
   Window Based Layout
   --------------------------------*/
  AdminUXAdmin.dashboardEcharts = function() {
    ...
    if($("#platform_type_dates_donut").length){
      ...
      var option_dt = {
        ...
        options : [
          {
            color: ['#dddddd','#25678b','#414b4f','#ee4b82','#45bbe0'],
            title : {
              text: '',
              subtext: ''
            },
...
// Initialize after dom ready
      ...
      var option = {
        ...
        xAxis: [{
          type: 'category',
          boundaryGap: false,
          data: ['2016-06-01','2016-05-01','2016-04-01','2016-03-01','2016-02-01','2016-01-01','2017-12-01','2017-11-01','2017-10-01','2017-09-01'],
          axisLine: {
            show: true,
            onZero: true,
            lineStyle: {
        ...
        series: [
          {
            ...
            itemStyle: {
              normal: {
                color:'#25678b',
                borderWidth:2, borderColor:'#25678b',
                areaStyle: {color:'#25678b', type: 'default'}
              }
            },
