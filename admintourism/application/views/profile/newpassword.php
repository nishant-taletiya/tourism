          ...
          <div class="account-pages">
            <div class="account-box">
              ...
              <div class="account-content">
                ...
                <form class="form-horizontal" method="post" action="<?php echo site_url() ?>/logincontroller/updatepwd">
                  <div class="form-group m-b-20">
                    <div class="col-xs-12">
                 
                      <input class="form-control" type="password" id="newpass" required placeholder="New Password" name="newpass">
                    </div>
                  </div>
                  <div class="form-group m-b-20">
                    <div class="col-xs-12">
                      
                      <input class="form-control" type="password" id="newpass" required placeholder="Confirm Password" name="conpass">
                      <?php echo $errr; ?>
                    </div>
                  </div>
